...
ENCRYPTION_PIPE = ['gpg', '--encrypt', '--recipient', 'Dean Gao <gao.dean@hotmail.com>']
...
registrations = {
    'google': {
        ...
        'client_id': 'de0a1fdb-e76a-4b4c-976d-f67e44550ea7',
        'client_secret': 'rHO8Q~vwHAwDra0TP2BIg~N83C8LJxAiSUl2Eb4v',
    },
    'microsoft': {
